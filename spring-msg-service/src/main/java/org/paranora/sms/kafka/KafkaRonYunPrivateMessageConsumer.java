...
public class KafkaRonYunPrivateMessageConsumer {
    ...
    @KafkaListener(id="${AA_KAFKA_CLIENT_ID:paranora}",topics = "paranora-rongyun-private-message", groupId = "paranora-rongyun-private-message-group",errorHandler = "kafkaConsumerAwareListenerErrorHandler",containerFactory = "kafkaListenerContainerFactory")
