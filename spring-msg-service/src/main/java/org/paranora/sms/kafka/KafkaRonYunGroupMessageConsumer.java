...
public class KafkaRonYunGroupMessageConsumer {
    ...
    @KafkaListener(id="${AA_KAFKA_CLIENT_ID:paranora}",topics = "${AA_KAFKA_TOPIC:rongyun-group-message}", groupId = "${AA_KAFKA_GROUP_ID:paranora-group-message-group}",errorHandler = "kafkaConsumerAwareListenerErrorHandler",containerFactory = "kafkaListenerContainerFactory")
